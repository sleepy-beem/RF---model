...
# Encoding target variable (overall sentiment) for SVM
...
# Plotting the distribution of scores for each category
...
# Plot score distributions as bar plots
...
# Plotting the overall sentiment distribution as a pie chart
